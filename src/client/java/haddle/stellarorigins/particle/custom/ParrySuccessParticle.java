...
import haddle.stellarorigins.particle.BillboardTrailParticle;
...
public class ParrySuccessParticle extends BillboardTrailParticle {
    protected ParrySuccessParticle(ClientWorld level, double xCoord, double yCoord, double zCoord,
                           SpriteProvider spriteSet, double xd, double yd, double zd) {
        super(level, xCoord, yCoord, zCoord, xd, yd, zd, spriteSet);
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType particleType, ClientWorld level, double x, double y, double z,
            ...
            return new ParrySuccessParticle(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
