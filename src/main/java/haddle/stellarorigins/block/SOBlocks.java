...
public class SOBlocks {
    ...
    public static final Block STARSTEEL_ORE = registerBlock("starsteel_ore",
            new OreBlock(FabricBlockSettings.of(Material.STONE).strength(2f).requiresTool(), UniformIntProvider.create(2,4)), SOItemGroups.STARSTEEL);
